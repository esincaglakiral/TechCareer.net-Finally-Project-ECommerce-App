...
const Home = () => {
    ...
    const nineProductsItem = products.slice(products.length - 9, products.length)
    ...
    return (
        ...
        <div className="home">
            <div className='homedropdown'>
                ...
                <button className='homedropbtn'>CATEGORIES</button>

                <div className='homecontent'>
                    <Link to="/mencategorylist" className='homecategory'>Men's Clothing</Link>
                    <Link to="/womencategorylist" className='homecategory'>Women's Clothing</Link>
                    <Link to="/electronicslist" className='homecategory'>Electronics</Link>
                    <Link to="/jewelerylist" className='homecategory'>Jewelery</Link>
                </div>

            </div>

            <div className='top'><h3>Top 9</h3></div>
            <div>

                <div className="products">
                    
                    {
                        nineProductsItem !== null && (nineProductsItem.map((product) => (
